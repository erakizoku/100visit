...
function clearSceneClickHandlers() {
  if (typingSkipHandler) {
    scene.removeEventListener("click", typingSkipHandler);
    typingSkipHandler = null;
  }

  if (advanceHandler) {
    scene.removeEventListener("click", advanceHandler);
    advanceHandler = null;
  }
}
...
function typeText(text) {
  return new Promise((resolve) => {
    ...
    function finishTyping() {
      ...
      scene.addEventListener("click", advanceHandler);
    }
    ...
    scene.addEventListener("click", typingSkipHandler);
    typeNext();
  });
}
...
function showInputOverlay() {
  return new Promise((resolve) => {
    ...
    function overlayClickBlocker(event) {
      event.stopPropagation();
    }
    ...
    function cleanup() {
      ...
      inputOverlay.removeEventListener("click", overlayClickBlocker);
      inputOverlay.classList.add("hidden");
    }

    inputOverlay.addEventListener("click", overlayClickBlocker);
